...
export const countTraffic = (traffic) => {
    // GB 
    if (traffic >= 1073741824) {
        return (traffic / 1073741824).toFixed(2) + ' GB'
    }
    if (traffic >= 1048576) {
        return (traffic / 1048576).toFixed(2) + ' MB'
    }
    if (traffic < 1048576) {
...
const transitionJsonToString = (jsonObj) => {
    // 转换后的jsonObj受体对象
    var _jsonObj = null;
    ...
    if (Object.prototype.toString.call(jsonObj) !== "[object String]") {
        try {
            ...
            // 转换失败错误信息
            Toast.error('您传递的json数据格式有误，请核对...');
        }
    } else {
        try {
